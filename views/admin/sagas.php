                    ...
                    foreach ($all_sagas as $saga) {
                        ...
                        echo "                 
                            <div class='table-rows'> 
                                <div class='table-cell'>{$saga['id']}</div>
                                <div class='table-cell'><a href='" . base_url . "admin/sagas&id={$saga['id']}'> {$saga['name']} </a></div>
                                
                                <div class='table-cell'> 
                                    
                                        <button class='edit-cat edit-button'><i class='fa-solid fa-pen-to-square'></i></button> 
                                    
                                    <a href='" . base_url . "admin/delete&id={$saga['id']}&entity=saga'>
                        ...
                        echo " </div> ";
                        require 'views/admin/edit-saga-block.php';
                        echo " </div> ";
