<aside id="sidebar">
    ...
    <ul id="category-block">
        <li><a href="<?=base_url?>admin/orders"><i class="fa-solid fa-shop"></i>Gestionar pedidos</a></li>
        <li><a href="<?=base_url?>admin/products"><i class="fa-brands fa-product-hunt"></i>Gestionar productos</a></li>
        ...
        <li><a href="<?=base_url?>admin/menu"><i class="fa-solid fa-bars"></i>Gestionar menú</a></li>
        <li><a href="<?=base_url?>admin/carriers"><i class="fa-solid fa-truck"></i>Gestionar transportistas</a></li>
